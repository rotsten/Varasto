...
CREATE TABLE VARASTO (
	...
	history_kuka_inventoi	  varchar(8), 
        ...
        CONSTRAIN fk_inv_tuote_id
            FOREIGN KEY (tuote_id)
            REFERENCES TUOTE (tuote_id) ON DELETE CASCASE,

         CONSTRAIN fk_inv_person
            FOREIGN KEY (history_kuka_inventoi) 
            REFERENCES KAYTTAJA (kayttajatunnus) ON DELETE NO ACTION
);
